...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Person'
        db.create_table('uvatracker_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uva_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('initial_solved', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_solved', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('checkpoint', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('uvatracker', ['Person'])


    def backwards(self, orm):
        # Deleting model 'Person'
        db.delete_table('uvatracker_person')
